        ...
        <main className="min-h-screen py-20">
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto mb-20">
                    <Link href="/more/quotes">
                        <motion.div
                            ...
                            className="p-8 rounded-2xl border bg-card hover:shadow-xl transition-all group cursor-pointer h-full"
                        >
                    ...
                    <Link href="/more/positions">
                        ...
                        >
                            ...
                            <p className="text-muted-foreground mb-4">Leadership roles and responsibilities I've held.</p>
                            <span className="inline-flex items-center text-sm text-primary group-hover:translate-x-1 transition-transform">
                ...
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-2xl font-bold mb-8 text-center">Quick Preview</h2>
                    ...
                    <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        transition={{ delay: 0.4 }}
                        className="p-8 rounded-2xl bg-gradient-to-r from-purple-500/10 to-pink-500/10 border mb-8"
                    >
                        <Quote className="h-8 w-8 mb-4 text-purple-500" />
                        <p className="text-xl italic mb-4">"{quotes[Math.floor(Math.random() * quotes.length)]}"</p>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        className="p-8 rounded-2xl bg-gradient-to-r from-orange-500/10 to-yellow-500/10 border mb-8"
                    >
                        <Lightbulb className="h-8 w-8 mb-4 text-orange-500" />
                        <p className="text-lg">💡 {randomFacts[Math.floor(Math.random() * randomFacts.length)]}</p>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        className="p-8 rounded-2xl bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border"
                    >
