        ...
        <>
            <main className="py-10 relative">
                ...
                <div className="container mx-auto px-6 max-w-6xl relative z-10">
                    <Link href="/more" className="inline-flex items-center gap-2 text-muted-foreground hover:text-foreground mb-6 transition-colors text-sm">
                        <ArrowLeft className="h-4 w-4" />
                        Back to More
                    </Link>

                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
                        <h1 className="text-2xl md:text-4xl font-semibold tracking-tight mb-1">Poems</h1>
                        <p className="text-sm text-muted-foreground/60">Written between the code.</p>
                    </motion.div>
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                className="relative min-h-[420px] bg-[#faf8f5] dark:bg-[#1c1a17] border border-black/8 dark:border-white/5 md:border-r-0 rounded-tl-sm rounded-bl-sm max-md:rounded-bl-none max-md:rounded-tr-sm overflow-hidden"
                            >
                                <div className="absolute inset-0 flex flex-col justify-between p-7 md:p-10">
                                    ...
                                    <div className="relative z-10">
                                        <p className="text-[10px] uppercase tracking-[0.4em] text-black/30 dark:text-white/30 mb-6">
                            ...
                            <motion.div
                                ...
                                className="relative min-h-[420px] bg-[#faf8f5] dark:bg-[#1c1a17] border border-black/8 dark:border-white/5 rounded-tr-sm rounded-br-sm max-md:rounded-tr-none max-md:rounded-bl-sm overflow-hidden"
                            >
                    ...
                    {/* Poem index */}
                    <div className="mt-6 border-t border-border/40 pt-4 grid grid-cols-2 sm:grid-cols-4 gap-2">
                        {poems.map((p, i) => (
                            <button
                                key={i}
                                onClick={() => jumpTo(i)}
