                ...
                <div className="container mx-auto px-6 max-w-6xl">
                    ...
                    >
                        <div className="flex items-baseline gap-4 mb-2">
                            <h1 className="text-2xl md:text-4xl font-semibold tracking-tight">Blogs</h1>
                    ...
                    >
                        <Link href={`/more/blog/${featured.slug}`}>
                            <div className="relative rounded-2xl border bg-gradient-to-br from-primary/5 via-card to-card p-8 md:p-10 hover:border-primary/30 hover:shadow-xl transition-all duration-300 overflow-hidden">
                                <span
                                ...
                                <div className="relative z-10">
                                    ...
                                    <h2 className="text-2xl md:text-3xl font-semibold mb-4 group-hover:text-primary transition-colors leading-snug tracking-tight">
                                        {featured.title}
                                    </h2>
                            ...
                            >
                                <Link href={`/more/blog/${blog.slug}`}>
                                    <div className="relative h-full rounded-2xl border bg-card p-6 hover:border-primary/30 hover:shadow-lg transition-all duration-300 overflow-hidden">
                                        ...
                                        <h3 className="text-base font-semibold mb-3 group-hover:text-primary transition-colors leading-snug tracking-tight">
                                            {blog.title}
                                        </h3>
